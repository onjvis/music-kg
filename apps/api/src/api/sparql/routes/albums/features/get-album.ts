...
import { GetSparqlResponse, iriWithPrefix, MusicAlbum, prefix2graph } from '@music-kg/sparql-data';
...
export const getAlbum = async (id: string, origin: DataOrigin): Promise<MusicAlbum> => {
